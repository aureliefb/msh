...
<html>
    ...
    <body>
        ...
        <header>
            ...
            <h2>Bienvenue <span class="admin-user"><?php echo $objetSession->get("pseudo");?></span></h2>
...
<!--                     <li>
                        ...
                        <a href="<?php //echo $this->generateUrl("admin-newsletter");  ?>">Créér une nouvelle Newsletter et gérer les contacts</a>
                    </li> -->
                    <li>
                        <i class="fa fa-shopping-basket" aria-hidden="true"></i>
                        <a href="<?php echo $this->generateUrl("admin-boutiques");  ?>">Gérer les boutiques et points de vente</a>
                    </li>
                    <li>
                        <i class="fa fa-sign-out" aria-hidden="true"></i><a href="<?php echo $this->generateUrl("logout"); ?>"> Déconnexion</a>
                    </li>
                </ul>
            </nav>
        </header>
